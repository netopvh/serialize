...
abstract class Generator
{
  ...
  {
    $path = config('serialize.generator.stubsOverridePath', __DIR__);
  ...
  {
    return config('serialize.generator.rootNamespace', $this->getAppNamespace());
  }
  ...
  {
    switch ($class) {
      case ('serializes' === $class):
        $path = config('serialize.generator.paths.serializes', 'Serializes');
        break;
      case ('interfaces' === $class):
        $path = config('serialize.generator.paths.interfaces', 'Serializes');
      default:
        $path = '';
    }
